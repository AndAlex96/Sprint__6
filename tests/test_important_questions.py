...
class TestImportantQuestionsOnStartPage:
    ...
    test_data = [(1, 1, 'Сутки — 400 рублей. Оплата курьеру — наличными или картой.'),
    ...
    @pytest.mark.parametrize('number_button, number_question, answer', test_data)
    def test_of_opening_the_answer_to_question(self, driver, number_button, number_question, answer):
